        ...
        <div className="flex flex-col md:flex-row md:flex-wrap items-center">
          ...
          <div className="flex mb-16 md:w-1/3">
            <div className="mr-4">
              ...
              <input id="apellido" className="shadow appearance-none border rounded-full w-full md:w-30 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder={empleado.last_name ? empleado.last_name : "Perez"} />
            </div>
          </div>
          <div className="flex mb-16 md:w-1/3">
            <div className="mr-4">
