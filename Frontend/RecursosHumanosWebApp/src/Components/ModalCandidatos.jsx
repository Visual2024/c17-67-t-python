    ...
    return (
        <section className="flex flex-col items-center justify-center w-full h-[480px]">
            <header className="flex items-center justify-center w-full mb-14 relative">
                ...
                {
                    paso === 4 && <h4 className="font-semibold text-gray-600 absolute bottom-[-30px] right-0">Confirma tus datos</h4>
                }
            </header>

            <div className="flex flex-col w-full">
                {
                    paso === 1 && <h2 className="text-center text-2xl font-semibold text-gray-600">Datos personales</h2>
                }
                {
                    paso === 2 && <h2 className="text-center text-2xl font-semibold text-gray-600">Datos de contacto</h2>
                }
                {
                    paso === 3 && <h2 className="text-center text-2xl font-semibold text-gray-600">Datos laborales</h2>
                }
                {
                    paso === 4 && <h2 className="text-center text-2xl font-semibold text-gray-600">Tus datos de postulación</h2>
                }
                <FormularioRegistro />
            </div>
        </section>
